This folder contains the files needed to visualize the maximum, minimum, and mean values for deltaS_weak at each position in the structure of DfrB1. These include:
